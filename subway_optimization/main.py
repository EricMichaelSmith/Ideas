...
2014-02-22: script hangs when I try to run it - figure out what's going wrong.
"""

import create_sample_distribution, find_best_fit_curve
...
def main():
  ...
  for lCurve in range(numCurves):
    ...
    find_best_fit_curve.main(distributionM)
